...
<html lang="en">
  ...
  <section class="page-title page-title-4 image-bg overlay">
          <div class="background-image-holder">
              <img alt="Background Image" class="background-image" src="img/europe-dymolab.jpg">
          </div>
          <div class="container">
              <div class="row">
                  <div class="col-md-6">
          ...
          <div class="container">
              <div class="row mb64 mb-xs-24">
                  <div class="col-sm-12 col-md-10 col-md-offset-1 text-center">
                      <h3>Why become part of the Dymolab network?</h3>
                  </div>
              </div>
          ...
          <div class="background-image-holder">
              <img alt="Background" class="background-image" src="img/app2.jpg">
          </div>
          <div class="container">
              <div class="row">
